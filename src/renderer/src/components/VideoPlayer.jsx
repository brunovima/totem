...
<<<<<<< HEAD
  ...
  // Fundo estático (preto): durante verificação de arquivo local, carregamento de vídeo
  // ou aguardando validação do YouTube — SEM animação para não conflitar com o vídeo
  const showStaticBg = !showAnimatedGradient && (
    isCheckingLocal ||
    (isVideo && !videoReady) ||
